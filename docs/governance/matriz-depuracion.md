...
| ADR-0015 | Crear un bounded context interbancario separado | Proposed | Proposed | Not started | Microservicios-cloud | Keep proposed | — |
| ADR-0016 | Representar Nostro/Vostro fuera de las cuentas de clientes | Proposed | Proposed | Not started | Microservicios-cloud | Keep proposed | — |
| ADR-0017 | Mantener un único plan contable para operaciones On-Us y Off-Us | Proposed | Proposed | Not started | Microservicios-cloud | Keep proposed | — |
| ADR-0018 | Utilizar posiciones interbancarias prefondeadas para la simulación R9-K | Proposed | Proposed | Not started | Microservicios-cloud | Keep proposed | — |
...
| ADR-0020 | Generar una clave de idempotencia estable en el Switch y propagarla extremo a extremo | Proposed | Proposed | Not started | Microservicios-cloud | Keep proposed | — |
| ADR-0021 | Tratar timeouts remotos como pendientes de conciliación | Proposed | Proposed | Not started | Microservicios-cloud | Keep proposed | — |
