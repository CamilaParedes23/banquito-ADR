# ADR-0012 — Exigir 70 % de cobertura en controllers y services del Switch
...
ASR: ASR-06
Disposition: Merged with ADR-0011 into a single testing standard
...
- `docs/standards/testing/cobertura-minima.md`
