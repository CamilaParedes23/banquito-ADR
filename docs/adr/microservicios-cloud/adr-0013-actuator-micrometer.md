...
ASR: ASR-04, ASR-05
Disposition: Moved to observability standard; tool configuration is not retained as a standalone strategic decision
...
- `docs/standards/observability/actuator-micrometer.md`
